...
export default async function Index() {
  ...
  return (
    <div className="flex-1 w-full flex flex-col items-center bg-black min-h-screen text-white pb-20">
      ...
      <div className="w-full max-w-5xl px-6 flex flex-col gap-12 mt-12 animate-in fade-in duration-700">
        ...
        {(!plans || plans.length === 0) && (
          <div className="text-center py-20 border border-dashed border-white/10 rounded-3xl">
            <p className="text-slate-500 font-mono">No market data discovered yet. Run monitor.js to populate.</p>
          </div>
        )}
      </div>
    </div>
