...
import RecentActivity from "@/components/RecentActivity"; // Ensure path is correct
...
export default function NexusDashboard() {
  ...
  useEffect(() => {
    async function fetchData() {
      // Adjusted to match your logic: selecting from pricing_plans and joining companies
    ...
    const discordMessage = {
      ...
      embeds: [{
        ...
        fields: [
          ...
          { name: "Project Detail", value: formData.get("message") as string }
        ],
  ...
  return (
    <div className="flex-1 w-full flex flex-col items-center bg-black min-h-screen text-white pb-20 relative selection:bg-blue-500/30">
      ...
      <div className="w-full max-w-7xl px-6 flex flex-col gap-10 mt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <aside className="lg:col-span-4 flex flex-col gap-4">
            <h3 className="text-xs font-mono text-slate-500 uppercase tracking-[0.2em] mb-2">Live Activity Log</h3>
            <RecentActivity />
          </aside>
      ...
      {/* FLOATING ACTION BUTTON & MODAL (Logic unchanged) */}
      <button 
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-[100] flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-white/10 p-10 rounded-[3.5rem] max-w-md w-full relative">
            {!submitted ? (
              <>
                ...
                <p className="text-slate-400 text-sm mb-8">Building autonomous pipelines and AI infrastructure.</p>
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <textarea name="message" required placeholder="Project details..." rows={3} className="bg-black/50 border border-white/10 p-4 rounded-2xl focus:border-blue-500 outline-none transition-colors" />
              ...
              <div className="text-center py-10">
                ...
                <p className="text-slate-400">Inquiry captured. I will contact you shortly.</p>
              </div>
            )}
          </div>
        </div>
